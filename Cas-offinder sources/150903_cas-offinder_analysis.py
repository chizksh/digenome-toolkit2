...
Indel_mismatch_num_1=0
Indel_mismatch_num_2=0
...
class casoffinder_analysis ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"cas-offinder analysis (server version) - no sqrt", pos = wx.DefaultPosition, size = wx.Size( 716,455 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
