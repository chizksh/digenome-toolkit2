...
mismatch_num_1 = 1
mismatch_num_2 = 1
mismatch_num_3_0 = 0.34
mismatch_num_3_1 = 0.39
mismatch_num_3_2 = 0.19
mismatch_num_3_3 = 0.021
mismatch_num_4_0 = 0.065
mismatch_num_4_1234 = 0.0060
...
class casoffinder_analysis ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"cas-offinder analysis (web version)", pos = wx.DefaultPosition, size = wx.Size( 616,455 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
    ...
    def mismatch_analysis(self, event):
        ...
        for line in fi.xreadlines():
            units = line.split()
            if not mismatch_dic.has_key(units[1]):
                mismatch_dic[units[1]] = []
                mismatch_score_dic[units[1]] = 0.0
            mismatch_dic[units[1]]+=[int(units[6])]
            
            
            mismatch_num=int(units[6])
            seed_seq = units[2][10:20]
            ...
            if mismatch_num == 6:
                mismatch_score_dic[units[1]]+=mismatch_num_6
                #print(mismatch_score_dic[units[0]])
            elif mismatch_num == 5:
                mismatch_score_dic[units[1]]+=mismatch_num_5
                #print(mismatch_score_dic[units[0]])
            elif mismatch_num == 4:
                if mismatch_num_seed == 0:
                    mismatch_score_dic[units[1]]+=mismatch_num_4_0
                else:
                    mismatch_score_dic[units[1]]+=mismatch_num_4_1234
                #print(mismatch_score_dic[units[0]])
            elif mismatch_num == 3:
                if mismatch_num_seed == 0:
                    mismatch_score_dic[units[1]]+=mismatch_num_3_0
                elif mismatch_num_seed == 1:
                    mismatch_score_dic[units[1]]+=mismatch_num_3_1
                elif mismatch_num_seed == 2:
                    mismatch_score_dic[units[1]]+=mismatch_num_3_2
                elif mismatch_num_seed == 3:
                    mismatch_score_dic[units[1]]+=mismatch_num_3_3
                #print(mismatch_score_dic[units[0]])
            elif mismatch_num == 2:
                mismatch_score_dic[units[1]]+=mismatch_num_1
            elif mismatch_num == 1 :
                mismatch_score_dic[units[1]]+=mismatch_num_2
